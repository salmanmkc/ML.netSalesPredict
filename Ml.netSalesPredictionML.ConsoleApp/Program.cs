...
namespace Ml.netSalesPredictionML.ConsoleApp
{
    class Program
    {
        ...
        private const string DATA_FILEPATH = @"C:\Users\13sch\source\repos\Ml.netSalesPrediction\Ml.netSalesPrediction\product-sales.csv";
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Single Prediction --> Actual value: {sampleData.ProductSales} | Predicted value: {predictionResult.Score}");
